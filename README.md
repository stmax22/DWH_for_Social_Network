# ETL Pipeline for DWH Social Network
Проект реализует ETL-пайплайн для построения хранилища данных социальной сети. Система собирает данные из S3-хранилища, загружает их в Staging-слой Vertica, трансформирует в DDS-слой и формирует аналитические запросы.
